...
public class PrestamoBiciclestas {
    ...
    public static void main(String[] args) {
        ...
        Estacion estacionesMasUsadas[] = EstacionDAO.consultarEstacionesMasUsadas(estaciones);
        ...
        EstacionDAO BalanceBicicletas = new EstacionDAO();
        BalanceBicicletas.getBalanceBicicletas(bicicletas);
